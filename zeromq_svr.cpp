...
const char* send_address="tcp://127.0.0.1:5556";
const char* recv_address="tcp://127.0.0.1:5555";
...
int main(int argc, char** argv)
{
	...
	else if(pid == 0)
	{
		...
		printf ("Connecting to server on port 5556 success...\n");
	...
	else
	{
		...
		printf("binding port passed .waiting client send message...res:%d\n", nRet);
